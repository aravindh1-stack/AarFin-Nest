        ...
        {member && (
          <>
            ...
            <div className="flex-1 overflow-y-auto px-6 py-6">
              ...
              <div className="mt-6 rounded-xl border border-slate-200/80 bg-white p-4 dark:border-slate-800/50 dark:bg-[#121212]">
                ...
                <div className="mt-3 flex gap-2">
                  ...
                  <button
                    type="button"
                    className="shrink-0 rounded-lg bg-teal-700 px-4 py-2.5 text-sm font-semibold text-white shadow-md shadow-teal-700/25 transition hover:bg-teal-600 disabled:cursor-not-allowed disabled:opacity-50 dark:bg-teal-600 dark:hover:bg-teal-500"
                    disabled={!amount}
                  >
                    Apply Payment
                  </button>
            ...
            <div className="border-t border-slate-200/70 px-6 py-4 dark:border-slate-800/50">
              <button
                type="button"
                className="w-full rounded-xl border border-slate-200 py-2.5 text-sm font-semibold text-slate-700 transition hover:border-teal-500/40 hover:text-teal-700 dark:border-slate-700 dark:text-slate-200 dark:hover:border-teal-500/40 dark:hover:text-teal-300"
              >
